...
export default function App() {
  ...
  const [step, setStep] = useState('select') // select | calendar | form | confirmed
  ...
  function handleContinue() {
    if (selectedSession && selectedDay && selectedTime) setStep('form')
  }

  function handleConfirmed(booking) {
              ...
              <div className="summary-info">
                ...
                {canContinue && (
                  <>
                    ...
                    <br />
                    <span>{`${selectedDay.day}/${selectedDay.month + 1}/${selectedDay.year}`} at {selectedTime.time} · {selectedSession.duration}</span>
                  </>
                )}
              </div>
              <button
